...
class _OpenStreetMapSearchAndPickState
  ...
  Widget build(BuildContext context) {
    return Consumer<GrupoProvider>(
      builder: (context, valorArmazenado, child) {
      return SafeArea(
        child: SizedBox(
          ...
          child: Stack(
            children: <Widget> [
              ...
              // destiny positioned
              if (valorArmazenado.ehIntegrante == false && valorArmazenado.ehAdministrador == false && valorArmazenado.coordenadasDaRota.isEmpty) 
                Positioned(
                  top: 70,
                  left: 0,
                  right: 0,
